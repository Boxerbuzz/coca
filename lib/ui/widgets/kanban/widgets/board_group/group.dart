...
typedef OnGroupReorder = void Function(String groupId, int fromIndex, int toIndex);
...
typedef AppFlowyBoardCardBuilder = Widget Function(
    BuildContext context, AppFlowyGroupData groupData, AppFlowyGroupItem item);

typedef AppFlowyBoardHeaderBuilder = Widget? Function(BuildContext context, AppFlowyGroupData groupData);

typedef AppFlowyBoardFooterBuilder = Widget Function(BuildContext context, AppFlowyGroupData groupData);
