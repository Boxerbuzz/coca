...
mixin BoardPhantomControllerDelegate {
  ...
  void moveGroupItemToAnotherGroup(String fromGroupId, int fromGroupIndex, String toGroupId, int toGroupIndex);
}
...
class BoardPhantomController extends OverlapDragTargetDelegate with CrossReorderFlexDragTargetDelegate {
  ...
  void _insertPhantom(String toGroupId, FlexDragTargetData dragTargetData, int phantomIndex) {
    final phantomContext = PassthroughPhantomContext(index: phantomIndex, dragTargetData: dragTargetData);
    phantomState.addGroupListener(toGroupId, phantomContext);

    delegate.insertPhantom(toGroupId, phantomIndex, PhantomGroupItem(phantomContext));
  ...
  /// * [dragTargetIndex]
  ///
  void _resetPhantomRecord(String groupId, FlexDragTargetData dragTargetData, int dragTargetIndex) {
    // Log.debug(
  ...
  @override
  bool acceptNewDragTargetData(String reorderFlexId, FlexDragTargetData dragTargetData, int dragTargetIndex) {
    if (phantomRecord == null) {
  ...
  void cancel() {
    ...
    /// Remove the phantom when the dragTarget is go back to the original group.
    _removePhantom(phantomRecord!.toGroupId);
    phantomRecord = null;
  }

  @override
  void dragTargetDidMoveToReorderFlex(String reorderFlexId, FlexDragTargetData dragTargetData, int dragTargetIndex) {
...
class PhantomRecord {
  ...
  PhantomRecord(
      {required this.toGroupId, required this.toGroupIndex, required this.fromGroupId, required this.fromGroupIndex});
  ...
  void updateInsertedIndex(int index) {
    ...
    Log.debug('[$PhantomRecord] Group:[$toGroupId] update position $toGroupIndex -> $index');
    toGroupIndex = index;
  }
...
class PassthroughPhantomContext extends FakeDragTargetEventTrigger
  ...
  AppFlowyGroupItem get itemData => dragTargetData.reorderFlexItem as AppFlowyGroupItem;
  ...
  PassthroughPhantomContext({required this.index, required this.dragTargetData});
...
class PassthroughPhantomWidget extends PhantomWidget {
  ...
  PassthroughPhantomWidget({required super.opacity, required this.passthroughPhantomContext, super.key})
