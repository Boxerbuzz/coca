...
class SizeTransitionWithIntrinsicSize extends SingleChildRenderObjectWidget {
  ...
  SizeTransitionWithIntrinsicSize({
    ...
    Widget? child,
    super.key,
  }) : super(child: SizeTransition(axis: axis, sizeFactor: sizeFactor, axisAlignment: axisAlignment, child: child));
  ...
  RenderSizeTransitionWithIntrinsicSize createRenderObject(BuildContext context) {
    return RenderSizeTransitionWithIntrinsicSize(axis: axis, sizeFactor: sizeFactor);
  }
...
class RenderSizeTransitionWithIntrinsicSize extends RenderProxyBox {
  ...
  RenderSizeTransitionWithIntrinsicSize({this.axis = Axis.vertical, required this.sizeFactor, RenderBox? child})
      : super(child);
