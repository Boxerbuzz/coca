...
class BoardOverlayEntry {
  ...
  BoardOverlayEntry({required this.builder, bool opaque = false}) : _opaque = opaque;
...
class BoardOverlay extends StatefulWidget {
  ...
  const BoardOverlay({this.initialEntries = const <BoardOverlayEntry>[], super.key});

  static BoardOverlayState of(BuildContext context, {Widget? debugRequiredFor}) {
    final BoardOverlayState? result = context.findAncestorStateOfType<BoardOverlayState>();
    assert(() {
...
class BoardOverlayState extends State<BoardOverlay> with TickerProviderStateMixin {
  ...
  void insertAll(Iterable<BoardOverlayEntry> entries, {BoardOverlayEntry? above}) {
    assert(above == null || (above._overlay == this && _entries.contains(above)));
  ...
  Widget build(BuildContext context) {
    ...
    return _BoardStack(
      onstage: Stack(fit: StackFit.passthrough, children: onstageChildren.reversed.toList(growable: false)),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<List<BoardOverlayEntry>>('entries', _entries));
  }
}
...
class _BoardStack extends RenderObjectWidget {
  ...
  const _BoardStack({required this.offstage, this.onstage});

  @override
  _BoardStackElement createElement() => _BoardStackElement(this);

  @override
  _RenderBoardObject createRenderObject(BuildContext context) => _RenderBoardObject();
}
...
class _BoardStackElement extends RenderObjectElement {
  ...
  _BoardStackElement(_BoardStack super.widget) : assert(!debugChildrenHaveDuplicateKeys(widget, widget.offstage));

  @override
  _BoardStack get widget => super.widget as _BoardStack;

  @override
  _RenderBoardObject get renderObject => super.renderObject as _RenderBoardObject;
